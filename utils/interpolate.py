...
#############################################################################
# This is taken from tensorflow_graphics library
# File is modified:
#   * function name is changed => trilinear_interpolation
#   * I needed to remove some of the checks to make it standalone
# If you have tensorflow-graphics library use that instead.
##############################################################################
...
def trilinear_interpolation(grid_3d, sampling_points, name="trilinear_interpolate"):
  ...
  with tf.name_scope(name):
    ...
    assert grid_3d.shape.ndims > 3
    assert sampling_points.shape.ndims > 1
